  ...
  <main>
    ...
    <section class="servicos inner">
      <div class="container">
        ...
        <p align="center">
          Imagine sua empresa atraindo mais clientes potenciais e convertendos em clientes fiéis. <br />
        ...
        <div class="row">
          <div class="col-md-6">
            <a href="http://materiais.4media.com.br/por-que-ter-um-site-responsivo">
              <img src="<?php echo get_template_directory_uri() ?>/images/book1.jpg" alt="" class="pull-xs-right" />
            </a>
          </div>
          <div class="col-md-6">
            <a href="http://materiais.4media.com.br/10-dicas-incr%C3%ADveis-para-conquistar-clientes-e-aumentar-suas-vendas">
              <img src="<?php echo get_template_directory_uri() ?>/images/book2.jpg" alt="" class="pull-xs-left" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          if ($blog_home->have_posts()):
            ...
            ?>
            <div class="col-md-4 wow fadeInDown" data-wow-duration="<?php echo $time ?>s" data-wow-delay="0.5s">
